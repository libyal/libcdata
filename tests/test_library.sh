...
LIBRARY_TESTS="array btree btree_node btree_values_list error list list_element range_list range_list_value support tree_node";
...
run_test()
{
	...
	local TEST_EXECUTABLE="./cdata_test_${TEST_NAME}";
...
run_test_with_input()
{
	...
	local TEST_PROFILE_DIRECTORY=$(get_test_profile_directory "input" "libcdata");
