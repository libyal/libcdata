...
Foreach (${TestName} in ${LibraryTests} -split " ")
{
	...
	$Result = RunTestBinary ${TestExecutablesDirectory} "cdata_test_${TestName}"
...
Foreach (${TestName} in ${LibraryTestsWithInput} -split " ")
{
	...
	{
		$Result = RunTestBinaryWithInput ${TestExecutablesDirectory} "cdata_test_${TestName}" ${TestInput}
