...
static void *(*cdata_test_real_memcpy)(void *, const void *, size_t) = NULL;
static void *(*cdata_test_real_memset)(void *, int, size_t)          = NULL;
static void *(*cdata_test_real_realloc)(void *, size_t)              = NULL;

int cdata_test_malloc_attempts_before_fail                           = -1;
int cdata_test_memcpy_attempts_before_fail                           = -1;
int cdata_test_memset_attempts_before_fail                           = -1;
       ...
       size_t size )
{
	...
	else if( cdata_test_malloc_attempts_before_fail > 0 )
	{
		cdata_test_malloc_attempts_before_fail--;
	}
	ptr = cdata_test_real_malloc(
	       size );
...
void *memcpy(
       ...
       size_t size )
{
	if( cdata_test_real_memcpy == NULL )
	{
		cdata_test_real_memcpy = dlsym(
		                          RTLD_NEXT,
		                          "memcpy" );
	}
	if( cdata_test_memcpy_attempts_before_fail == 0 )
	{
		cdata_test_memcpy_attempts_before_fail = -1;

		return( NULL );
	}
	else if( cdata_test_memcpy_attempts_before_fail > 0 )
	{
		cdata_test_memcpy_attempts_before_fail--;
	}
	destination = cdata_test_real_memcpy(
	               destination,
	               source,
	               size );
...
void *memset(
       ...
       size_t size )
{
	if( cdata_test_real_memset == NULL )
	{
		cdata_test_real_memset = dlsym(
		                          RTLD_NEXT,
		                          "memset" );
	}
	if( cdata_test_memset_attempts_before_fail == 0 )
	{
		cdata_test_memset_attempts_before_fail = -1;

		return( NULL );
	}
	else if( cdata_test_memset_attempts_before_fail > 0 )
	{
		cdata_test_memset_attempts_before_fail--;
	}
	ptr = cdata_test_real_memset(
	       ptr,
	       constant,
	       size );
       ...
       size_t size )
{
	...
	else if( cdata_test_realloc_attempts_before_fail > 0 )
	{
		cdata_test_realloc_attempts_before_fail--;
	}
	ptr = cdata_test_real_realloc(
	       ptr,
	       size );
